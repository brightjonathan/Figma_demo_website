    ...
    <nav className='z-10 md:hidden flex justify-center w-[90vw] bg-[#181818] pb-[10px] fixed'>
      <div className='pt-5 px-2 flex justify-around'>
        ...
        <div className=" w-[10%] pt-3  pl-4" onClick={handleMenuClick}>
          {
            isMenuOpen ? (<AiOutlineClose size='40px' cursor="pointer" />) : 
              ...
              <div className='flex flex-col items-center w-[30%] ' onClick={handleMenuClick} >
                 {
                  navlinks.map((link, index)=>{
                    return(
                      <motion.div key={index} className='flex flex-col pr-7 text-[16px]'>
                         <Link to={link.url}>
